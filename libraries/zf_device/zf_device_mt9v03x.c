...
float auto_exp = MT9V03X_AUTO_EXP_DEF;
float exp_time = MT9V03X_EXP_TIME_DEF;
...
{
    mt9v03x_set_confing_buffer[1][1] = (uint16) auto_exp;
    mt9v03x_set_confing_buffer[2][1] = (uint16) exp_time;
    uint8 return_state = 0;
